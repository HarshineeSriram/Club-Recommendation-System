...
class recommendations:
    ...
    def similarity_coeff(self, student1_hash_key, student2_hash_key):
        if(student1_hash_key != student2_hash_key):
            ...
            return((len(np.intersect1d(np.array(list_1), np.array(list_2)))/4) + 1)
        return 0
    ...
    def generate_similarity_index(self) -> None:
        ...
        self.all_similarity_indices = np.array(self.all_club_lengths) * np.array(self.all_pairwise_personal)
