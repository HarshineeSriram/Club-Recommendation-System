...
class recommendations:
    ...
    def find_other_clubs(self, this_student_clubs:list, another_student_clubs:list) -> None:
    ...
    def generate_recommendations(self) -> None:
        ...
        for this_student in range(self.number_of_students):
            ...
            values = [[] for i in range(self.number_of_clubs)]
            ...
            for other_student in range(1, self.number_of_students+1):
                ...
                if(other_hash_key != this_hash_key):
                    ...
                    for club in this_unique_clubs:
                        self.this_clubs_scores[club] = self.this_clubs_scores[club] + self.get_importance(this_student, other_hash_key)

            for key in list(self.this_clubs_scores.keys()):
                if key in self.this_clubs:
                    del self.this_clubs_scores[key]

            self.this_clubs_scores = sorted(self.this_clubs_scores, reverse=True)
